-- 009_submit_attempt_locked — adds level-gating check to submit_attempt.
-- Replaces the function from 006; all logic is identical except the new
-- v_user_level / v_unlock_level check inserted after the rate guard.
